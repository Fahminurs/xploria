function setCategoryCharacter() {
  ...
  $('#category_custom').attr('name',Blockly.Msg.CATEGORY_CUSTOM);
  $('#category_custom_blink').attr('name','Blink');
  $('#category_custom_lcd').attr('name','LCD I2C');
  $('#category_custom_scanning').attr('name','Scanning LCD');
  $('#category_robot').attr('name',Blockly.Msg.CATEGORY_ROBOT);
  //  $('#category_involt').attr('name',Blockly.Msg.CATEGORY_INVOLT);
  // ESP32 categories
  $('#category_esp32').attr('name','ESP32');
  $('#category_esp32_gpio').attr('name','GPIO');
  $('#category_esp32_analog_pwm').attr('name','Analog & PWM');
  $('#category_esp32_comm').attr('name','Communication');
  $('#category_esp32_misc').attr('name','Misc');
  $('#category_esp32_neopixel').attr('name','NeoPixel');
  // Custom parent category for Digital Write
  $('#category_digital_write_parent').attr('name','Digital Write');
  // Custom parent category for Pin Mode
  $('#category_pin_mode_parent').attr('name','Pin Mode');
  // Declaration category
  $('#category_declaration').attr('name','Declaration');
  // Delay category
  $('#category_delay_parent').attr('name','Delay');
